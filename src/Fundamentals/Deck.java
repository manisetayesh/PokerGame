...
public class Deck{
	...
	public Deck(){
		...
		for(int suit = Card.DIAMOND; suit <= Card.SPADE; suit++) {
			...
			for (int rank = 1; rank <= 13; rank++) {
				...
				//Filling up the array, one at a time with Fundamentals.Card objects
	 ...
	 * Output: a Fundamentals.Card from the deck of cards
